(function (){
	...
	// ** defining myBookmarklet without window will result in an error
	// ** since myBookmarklet is not defined outside iffe
	...
	if(typeof window.jQuery !== 'undefined'){
		console.log('when jQuery is defined');
		myBookmarklet();
	} else {
		// check for conflicts
		...
		(function (){
			...
			if(typeof window.jQuery == 'undefined'){
				...
				console.log('when bookmarklet defined');
				myBookmarklet();
			}
		});
	}
